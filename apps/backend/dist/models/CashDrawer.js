...
const cashDrawerSchema = new mongoose_1.Schema({
    ...
    openedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
...
exports.CashDrawer = mongoose_1.default.model('CashDrawer', cashDrawerSchema);
