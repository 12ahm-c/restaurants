...
export const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    'tables.occupied': 'Tentes occupées',
  ...
  en: {
    ...
    'tables.occupied': 'Occupied Tents',
  ...
  ar: {
    ...
    'tables.occupied': 'الخيام المشغولة',
    ...
    'customers.debt': 'الدَّين',

    // Inventory
    'inventory.title': 'المخزون',
    'inventory.subtitle': 'إدارة عناصر المخزون وإعادة التعبئة وتتبع الكميات',
    'inventory.addItem': 'إضافة عنصر',
    'inventory.totalItems': 'إجمالي العناصر',
    'inventory.totalValue': 'قيمة المخزون',
    'inventory.belowThreshold': 'منخفض المخزون',
    ...
    'inventory.restock': 'إعادة تعبئة',
    'inventory.adjust': 'تعديل الكمية',
    'inventory.adjustStock': 'تعديل كمية المخزون',
    'inventory.adjustType': 'نوع التعديل',
    'inventory.replenishment': 'إعادة تعبئة (+)',
    'inventory.deduction': 'خصم (-)',
    'inventory.waste': 'هدر (-)',
    'inventory.adjustment': 'تعديل يدوي',
    'inventory.reason': 'السبب',
    'inventory.supplierPrice': 'سعر الشراء من المورد',
    'inventory.categoryPlaceholder': 'مثال: خضروات، لحوم، مشروبات',
    'inventory.unitKg': 'كيلوغرام (kg)',
    'inventory.unitG': 'غرام (g)',
    'inventory.unitL': 'لتر (L)',
    'inventory.unitMl': 'مليلتر (ml)',
    'inventory.unitPcs': 'قطعة (pcs)',
    'inventory.unitBox': 'صندوق (box)',
    ...
    'suppliers.subtitle': 'إدارة الموردين وتتبع الديون والحركات المالية',
    'suppliers.addSupplier': 'إضافة مورد',
    'suppliers.totalSuppliers': 'إجمالي الموردين',
    'suppliers.totalDebt': 'إجمالي الديون للموردين',
    'suppliers.search': 'بحث عن مورد...',
    'suppliers.noSuppliers': 'لا يوجد موردون',
    'suppliers.movements': 'حركات الدَّين',
    'suppliers.noMovements': 'لا توجد حركات مسجلة',
