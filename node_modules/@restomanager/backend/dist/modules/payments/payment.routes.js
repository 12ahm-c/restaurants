...
router.get('/cash-drawer', (0, rbac_1.requireRole)('manager', 'owner'), payment_controller_1.PaymentController.getCashDrawer);
router.post('/cash-drawer/open', (0, rbac_1.requireRole)('manager', 'owner'), payment_controller_1.PaymentController.openCashDrawer);
router.post('/cash-drawer/close', (0, rbac_1.requireRole)('manager', 'owner'), payment_controller_1.PaymentController.closeCashDrawer);
